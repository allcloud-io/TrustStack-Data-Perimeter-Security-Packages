/**
 * TypeScript definitions for AWS::ElasticLoadBalancingV2::LoadBalancer
 ...
 */
export namespace AWS_ElasticLoadBalancingV2_LoadBalancer {
  /**
   * The minimum capacity for a load balancer.
   */
  export type MinimumLoadBalancerCapacityType = {
    /**
   ...
   */
  export type LoadBalancerAttributeType = {
    /**
  ...
  export type LoadBalancerResourceType = {
     ...
     */
    LoadBalancerAttributes?: LoadBalancerAttributeType[];

    /**
     * The minimum capacity for a load balancer.
     */
    MinimumLoadBalancerCapacity?: MinimumLoadBalancerCapacityType;
