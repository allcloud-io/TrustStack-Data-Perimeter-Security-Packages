/**
 * TypeScript definitions for AWS::SageMaker::DataQualityJobDefinition
 ...
 */
export namespace AWS_SageMaker_DataQualityJobDefinition {
  /**
   * Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
   */
  export type DataQualityBaselineConfigType = {
   ...
   */
  export type DataQualityAppSpecificationType = {
    /**
   ...
   */
  export type DataQualityJobInputType = {
   ...
   * Resource Type definition for AWS::SageMaker::DataQualityJobDefinition
   */
  export type DataQualityJobDefinitionResourceType = {
    /**
     ...
     * Create-only property
     */
    DataQualityBaselineConfig?: DataQualityBaselineConfigType;

    /**
     * Create-only property
     */
    DataQualityAppSpecification: DataQualityAppSpecificationType;

    /**
     * Create-only property
     */
    DataQualityJobInput: DataQualityJobInputType;

    /**
     * Create-only property
     */
    DataQualityJobOutputConfig: MonitoringOutputConfigType;
