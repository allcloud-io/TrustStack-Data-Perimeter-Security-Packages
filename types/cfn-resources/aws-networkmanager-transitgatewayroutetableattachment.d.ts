/**
 * TypeScript definitions for AWS::NetworkManager::TransitGatewayRouteTableAttachment
 ...
 */
export namespace AWS_NetworkManager_TransitGatewayRouteTableAttachment {
  /**
   ...
   * AWS::NetworkManager::TransitGatewayRouteTableAttachment Resource Type definition.
   */
  export type TransitGatewayRouteTableAttachmentResourceType = {
    /**
