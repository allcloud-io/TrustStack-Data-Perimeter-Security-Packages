/**
 * TypeScript definitions for AWS::ECS::TaskDefinition
...
export namespace AWS_ECS_TaskDefinition {
   ...
   * +  Container health checks are supported for Fargate tasks if you are using platform version 1.1.0 or greater. For more information, see Platform Versions.
  ...
  export type ContainerDefinitionType = {
     ...
     */
    EnvironmentFiles?: EnvironmentFileType[];
     ...
     */
    SystemControls?: SystemControlType[];
   ...
   */
  export type DockerVolumeConfigurationType = {
    /**
   ...
   */
  export type KernelCapabilitiesType = {
    /**
   ...
   */
  export type FSxAuthorizationConfigType = {
    /**
  ...
  export type LinuxParametersType = {
     ...
     */
    Capabilities?: KernelCapabilitiesType;
   ...
   */
  export type HostVolumePropertiesType = {
    /**
  ...
  export type ProxyConfigurationType = {
     ...
     */
    ProxyConfigurationProperties?: KeyValuePairType[];
  ...
  export type VolumeType = {
     ...
     */
    DockerVolumeConfiguration?: DockerVolumeConfigurationType;

    /**
     * This parameter is specified when you use Amazon FSx for Windows File Server file system for task storage.
     */
    FSxWindowsFileServerVolumeConfiguration?: FSxWindowsFileServerVolumeConfigurationType;
   ...
   */
  export type InferenceAcceleratorType = {
    /**
  ...
  /**
   * The amount of ephemeral storage to allocate for the task. This parameter is used to expand the total amount of ephemeral storage available, beyond the default amount, for tasks hosted on FARGATElong. For more information, see Using data volumes in tasks in the *Amazon ECS Developer Guide;*.
   ...
   * For more information and the input format, see Amazon FSx for Windows File Server volumes in the *Amazon Elastic Container Service Developer Guide*.
   */
  export type FSxWindowsFileServerVolumeConfigurationType = {
    /**
     * The authorization configuration details for the Amazon FSx for Windows File Server file system.
     */
    AuthorizationConfig?: FSxAuthorizationConfigType;
  ...
  export type TaskDefinitionResourceType = {
     ...
     * Create-only property
     */
    InferenceAccelerators?: InferenceAcceleratorType[];
     ...
     * Create-only property
     */
    PlacementConstraints?: TaskDefinitionPlacementConstraintType[];
     ...
     * Create-only property
     */
    ContainerDefinitions?: ContainerDefinitionType[];
