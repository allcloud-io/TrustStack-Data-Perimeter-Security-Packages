/**
 * TypeScript definitions for AWS::SageMaker::ModelQualityJobDefinition
 ...
 */
export namespace AWS_SageMaker_ModelQualityJobDefinition {
  /**
   * Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
   */
  export type ModelQualityBaselineConfigType = {
   ...
   */
  export type ModelQualityAppSpecificationType = {
    /**
   ...
   */
  export type ModelQualityJobInputType = {
    EndpointInput?: EndpointInputType;

    BatchTransformInput?: BatchTransformInputType;

    GroundTruthS3Input: MonitoringGroundTruthS3InputType;
  };
  ...
  export type EndpointInputType = {
     ...
     */
    StartTimeOffset?: MonitoringTimeOffsetStringType;

    /**
     * Monitoring end time offset, e.g. PT0H
     */
    EndTimeOffset?: MonitoringTimeOffsetStringType;
   ...
   */
  export type ProblemTypeType = {};

  /**
   * Ground truth input provided in S3
   */
  export type MonitoringGroundTruthS3InputType = {
    /**
     * A URI that identifies the Amazon S3 storage location where Amazon SageMaker saves the results of a monitoring job.
     */
    S3Uri: string;
   ...
   * Resource Type definition for AWS::SageMaker::ModelQualityJobDefinition
   */
  export type ModelQualityJobDefinitionResourceType = {
    /**
     ...
     * Create-only property
     */
    ModelQualityBaselineConfig?: ModelQualityBaselineConfigType;

    /**
     * Create-only property
     */
    ModelQualityAppSpecification: ModelQualityAppSpecificationType;

    /**
     * Create-only property
     */
    ModelQualityJobInput: ModelQualityJobInputType;

    /**
     * Create-only property
     */
    ModelQualityJobOutputConfig: MonitoringOutputConfigType;
