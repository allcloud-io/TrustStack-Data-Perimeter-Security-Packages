/**
 * TypeScript definitions for AWS::Config::ConfigRule
 ...
 * CC Managed Rules are predefined, customizable rules created by CC. For a list of managed rules, see List of Managed Rules. If you are adding an CC managed rule, you must specify the rule's identifier for the `SourceIdentifier` key.
 ...
 */
export namespace AWS_Config_ConfigRule {
  /**
   ...
   */
  export type CustomPolicyDetailsType = {
    /**
  ...
  export type SourceType = {
     ...
     */
    CustomPolicyDetails?: CustomPolicyDetailsType;

    /**
     * For CC Managed rules, a predefined identifier from a list. For example, `IAM_PASSWORD_POLICY` is a managed rule. To reference a managed rule, see List of Managed Rules.
     ...
     * CC Custom Rules are rules that you can develop either with Guard (`CUSTOM_POLICY`) or LAMlong (`CUSTOM_LAMBDA`). For more information, see Custom Rules in the *developer guide*.
     */
    Owner: string;
   ...
   * For more information about developing and using CC rules, see Evaluating Resources with Rules in the *Developer Guide*.
   */
  export type ConfigRuleResourceType = {
    /**
     * Read-only property
     */
    ConfigRuleId?: string;
     ...
     */
    EvaluationModes?: EvaluationModeConfigurationType[];
  };
}
