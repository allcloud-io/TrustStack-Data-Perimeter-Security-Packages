/**
 * TypeScript definitions for AWS::Redshift::Cluster
 ...
 */
export namespace AWS_Redshift_Cluster {
  ...
  export type LoggingPropertiesType = {
    BucketName?: string;
  ...
  export type ClusterResourceType = {
    ...
    LoggingProperties?: LoggingPropertiesType;
