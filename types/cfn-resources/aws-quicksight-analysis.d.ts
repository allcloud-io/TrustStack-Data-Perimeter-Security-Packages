/**
 * TypeScript definitions for AWS::QuickSight::Analysis
 ...
 */
export namespace AWS_QuickSight_Analysis {
  ...
  export type AnalysisErrorTypeType = {};
   ...
   */
  export type AnalysisSourceTemplateType = {
    /**
   ...
   */
  export type AnalysisSourceEntityType = {
    SourceTemplate?: AnalysisSourceTemplateType;
  };
  ...
  export type AnalysisDefinitionType = {
   ...
   * Definition of the AWS::QuickSight::Analysis Resource Type.
   */
  export type AnalysisResourceType = {
    ...
    SourceEntity?: AnalysisSourceEntityType;
    ...
    Definition?: AnalysisDefinitionType;
