/**
 * TypeScript definitions for AWS::ECS::Service
 ...
 */
export namespace AWS_ECS_Service {
  /**
   ...
   */
  export type TimeoutConfigurationType = {
    /**
   ...
   */
  export type DeploymentAlarmsType = {
    /**
   ...
   */
  export type ServiceConnectTlsCertificateAuthorityType = {
    /**
   ...
   */
  export type VpcLatticeConfigurationType = {
    /**
   ...
   */
  export type ServiceConnectConfigurationType = {
    /**
     ...
     */
    Services?: ServiceConnectServiceType[];
   ...
   */
  export type ServiceConnectTlsConfigurationType = {
    /**
     * The signer certificate authority.
     */
    IssuerCertificateAuthority: ServiceConnectTlsCertificateAuthorityType;
   ...
   */
  export type ServiceManagedEBSVolumeConfigurationType = {
    /**
    ...
    /**
     * The Amazon Resource Name (ARN) identifier of the AWS Key Management Service key to use for Amazon EBS encryption. When encryption is turned on and no AWS Key Management Service key is specified, the default AWS managed key for Amazon EBS volumes is used. This parameter maps 1:1 with the `KmsKeyId` parameter of the CreateVolume API in the *Amazon EC2 API Reference*.
     ...
     */
    TagSpecifications?: EBSTagSpecificationType[];
   ...
   * Tasks that run in a namespace can use short names to connect to services in the namespace. Tasks can connect to services across all of the clusters in the namespace. Tasks connect through a managed proxy container that collects logs and metrics for increased visibility. Only the tasks that Amazon ECS services create are supported with Service Connect. For more information, see Service Connect in the *Amazon Elastic Container Service Developer Guide*.
   */
  export type ServiceConnectClientAliasType = {
    /**
   ...
   */
  export type ServiceVolumeConfigurationType = {
    /**
     * The configuration for the Amazon EBS volume that Amazon ECS creates and manages on your behalf. These settings are used to create each Amazon EBS volume, with one volume created for each task in the service. The Amazon EBS volumes are visible in your account in the Amazon EC2 console once they are created.
     */
    ManagedEBSVolume?: ServiceManagedEBSVolumeConfigurationType;
   ...
   * In order to tag a service that has the following ARN format, you need to migrate the service to the long ARN. You must use the API, CLI or console to migrate the service ARN. For more information, see Migrate an short service ARN to a long ARN in the *Developer Guide*.
   ...
   */
  export type DeploymentCircuitBreakerType = {
    /**
  ...
  export type DeploymentConfigurationType = {
     ...
     */
    DeploymentCircuitBreaker?: DeploymentCircuitBreakerType;
   ...
   */
  export type EBSTagSpecificationType = {
    /**
   ...
   */
  export type ServiceConnectServiceType = {
    /**
     * A reference to an object that represents the configured timeouts for Service Connect.
     */
    Timeout?: TimeoutConfigurationType;
     ...
     */
    ClientAliases?: ServiceConnectClientAliasType[];

    /**
     * A reference to an object that represents a Transport Layer Security (TLS) configuration.
     */
    Tls?: ServiceConnectTlsConfigurationType;
  ...
  export type ServiceResourceType = {
     ...
     */
    VolumeConfigurations?: ServiceVolumeConfigurationType[];
     ...
     * Tasks that run in a namespace can use short names to connect to services in the namespace. Tasks can connect to services across all of the clusters in the namespace. Tasks connect through a managed proxy container that collects logs and metrics for increased visibility. Only the tasks that Amazon ECS services create are supported with Service Connect. For more information, see Service Connect in the *Amazon Elastic Container Service Developer Guide*.
     */
    ServiceConnectConfiguration?: ServiceConnectConfigurationType;
     ...
     */
    VpcLatticeConfigurations?: VpcLatticeConfigurationType[];
