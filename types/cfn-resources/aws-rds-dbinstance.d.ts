/**
 * TypeScript definitions for AWS::RDS::DBInstance
 ...
 * 1.  Create a snapshot of the DB instance. For more information, see Creating a DB Snapshot.
 ...
 * 1.  Update the stack.
 * For more information about updating other properties of this resource, see `ModifyDBInstance`. For more information about updating stacks, see CloudFormation Stacks Updates.
 ...
 */
export namespace AWS_RDS_DBInstance {
  /**
   ...
   */
  export type DBInstanceRoleType = {
    /**
   ...
   */
  export type ProcessorFeatureType = {
    /**
  ...
  export type DBInstanceResourceType = {
     ...
     */
    AssociatedRoles?: DBInstanceRoleType[];
     ...
     */
    ProcessorFeatures?: ProcessorFeatureType[];
