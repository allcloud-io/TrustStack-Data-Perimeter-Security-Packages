/**
 * TypeScript definitions for AWS::Neptune::DBCluster
 ...
 */
export namespace AWS_Neptune_DBCluster {
  /**
   ...
   */
  export type ServerlessScalingConfigurationType = {
    /**
  ...
  export type DBClusterResourceType = {
     ...
     */
    ServerlessScalingConfiguration?: ServerlessScalingConfigurationType;
