/**
 * TypeScript definitions for AWS::RDS::DBCluster
 ...
 * 1.  Create a snapshot of the DB cluster. For more information, see Creating a DB cluster snapshot.
 ...
 */
export namespace AWS_RDS_DBCluster {
  /**
  ...
  /**
   * The `ServerlessV2ScalingConfiguration` property type specifies the scaling configuration of an Aurora Serverless V2 DB cluster. For more information, see Using Amazon Aurora Serverless v2 in the *Amazon Aurora User Guide*.
   ...
   */
  export type ScalingConfigurationType = {
    /**
   ...
   */
  export type MasterUserSecretType = {
    /**
  ...
  export type DBClusterResourceType = {
     ...
     */
    AssociatedRoles?: DBClusterRoleType[];
     ...
     * For more information, see Password management with Secrets Manager in the *Amazon RDS User Guide* and Password management with Secrets Manager in the *Amazon Aurora User Guide.*
     */
    MasterUserSecret?: MasterUserSecretType;
