/**
 * TypeScript definitions for AWS::IAM::GroupPolicy
 ...
 * For information about the maximum number of inline policies that you can embed in a group, see IAM and quotas in the *IAM User Guide*.
 */
export namespace AWS_IAM_GroupPolicy {
  /**
   * Adds or updates an inline policy document that is embedded in the specified IAM group.
   * A group can also have managed policies attached to it. To attach a managed policy to a group, use AWS::IAM::Group. To create a new managed policy, use AWS::IAM::ManagedPolicy. For information about policies, see Managed policies and inline policies in the *IAM User Guide*.
   * For information about the maximum number of inline policies that you can embed in a group, see IAM and quotas in the *IAM User Guide*.
   */
  export type GroupPolicyResourceType = {
    /**
     * The policy document.
