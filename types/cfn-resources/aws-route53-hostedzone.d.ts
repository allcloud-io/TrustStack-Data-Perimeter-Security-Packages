/**
 * TypeScript definitions for AWS::Route53::HostedZone
 ...
 */
export namespace AWS_Route53_HostedZone {
  /**
   * A complex type that contains an optional comment about your hosted zone. If you don't want to specify a comment, omit both the `HostedZoneConfig` and `Comment` elements.
   */
  export type HostedZoneConfigType = {
    /**
   ...
   */
  export type QueryLoggingConfigType = {
    /**
   ...
   * For more information, see Access Management in the *General Reference*.
   */
  export type HostedZoneResourceType = {
    /**
     * Read-only property
     */
    Id?: string;
     ...
     */
    HostedZoneConfig?: HostedZoneConfigType;

    /**
     * Adds, edits, or deletes tags for a health check or a hosted zone.
     * For information about using tags for cost allocation, see Using Cost Allocation Tags in the *User Guide*.
     */
    HostedZoneTags?: HostedZoneTagType[];
     ...
     */
    QueryLoggingConfig?: QueryLoggingConfigType;
