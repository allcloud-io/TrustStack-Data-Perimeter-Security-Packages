/**
 * TypeScript definitions for AWS::CloudFormation::ResourceVersion
 ...
 */
export namespace AWS_CloudFormation_ResourceVersion {
   ...
   * A resource that has been registered in the CloudFormation Registry.
   */
  export type ResourceVersionResourceType = {
    /**
