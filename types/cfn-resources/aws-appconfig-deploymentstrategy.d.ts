/**
 * TypeScript definitions for AWS::AppConfig::DeploymentStrategy
 ...
 */
export namespace AWS_AppConfig_DeploymentStrategy {
  /**
   ...
   * Resource Type definition for AWS::AppConfig::DeploymentStrategy
   */
  export type DeploymentStrategyResourceType = {
    /**
