/**
 * TypeScript definitions for AWS::ElasticLoadBalancingV2::ListenerRule
 ...
 */
export namespace AWS_ElasticLoadBalancingV2_ListenerRule {
  /**
  ...
  export type RuleConditionType = {
     ...
     */
    HttpRequestMethodConfig?: HttpRequestMethodConfigType;

    /**
     * Information for a path pattern condition. Specify only when `Field` is `path-pattern`.
     */
    PathPatternConfig?: PathPatternConfigType;

    /**
     * Information for an HTTP header condition. Specify only when `Field` is `http-header`.
     */
    HttpHeaderConfig?: HttpHeaderConfigType;

    /**
     * Information for a source IP condition. Specify only when `Field` is `source-ip`.
     */
    SourceIpConfig?: SourceIpConfigType;

    /**
     * Information for a host header condition. Specify only when `Field` is `host-header`.
     */
    HostHeaderConfig?: HostHeaderConfigType;

    /**
     * Information for a query string condition. Specify only when `Field` is `query-string`.
     */
    QueryStringConfig?: QueryStringConfigType;
  };
   ...
   */
  export type PathPatternConfigType = {
    /**
   ...
   */
  export type HttpHeaderConfigType = {
    /**
   ...
   */
  export type QueryStringKeyValueType = {
    /**
     * The value.
     */
    Value?: string;
   ...
   */
  export type HostHeaderConfigType = {
    /**
   ...
   */
  export type HttpRequestMethodConfigType = {
    /**
   ...
   */
  export type SourceIpConfigType = {
    /**
   ...
   * For more information, see Quotas for your Application Load Balancers in the *User Guide for Application Load Balancers*.
   */
  export type ListenerRuleResourceType = {
    /**
