/**
 * TypeScript definitions for AWS::CloudFront::Distribution
 ...
 */
export namespace AWS_CloudFront_Distribution {
  /**
  ...
  export type CacheBehaviorType = {
     ...
     */
    ForwardedValues?: ForwardedValuesType;

    /**
     * A list of CloudFront functions that are associated with this cache behavior. CloudFront functions must be published to the `LIVE` stage to associate them with a cache behavior.
     */
    FunctionAssociations?: FunctionAssociationType[];

    /**
     * The gRPC configuration for your cache behavior.
     */
    GrpcConfig?: GrpcConfigType;

    /**
     * A complex type that contains zero or more Lambda@Edge function associations for a cache behavior.
     */
    LambdaFunctionAssociations?: LambdaFunctionAssociationType[];
  ...
  export type CookiesType = {
     ...
     * For the current limit on the number of cookie names that you can whitelist for each cache behavior, see CloudFront Limits in the *General Reference*.
     */
   ...
   */
  export type CustomOriginConfigType = {
    /**
   ...
   */
  export type DefaultCacheBehaviorType = {
    /**
     * A complex type that controls which HTTP methods CloudFront processes and forwards to your Amazon S3 bucket or your custom origin. There are three choices:
     * +  CloudFront forwards only `GET` and `HEAD` requests.
     * +  CloudFront forwards only `GET`, `HEAD`, and `OPTIONS` requests.
   ...
   */
  export type DistributionConfigType = {
    /**
     ...
     */
    CacheBehaviors?: CacheBehaviorType[];
     ...
     * For more information about custom error pages, see Customizing Error Responses in the *Amazon CloudFront Developer Guide*.
     */
    CustomErrorResponses?: CustomErrorResponseType[];
     ...
     */
    CustomOrigin?: LegacyCustomOriginType;

    /**
     * A complex type that describes the default cache behavior if you don't specify a `CacheBehavior` element or if files don't match any of the values of `PathPattern` in `CacheBehavior` elements. You must create exactly one default cache behavior.
     */
    DefaultCacheBehavior: DefaultCacheBehaviorType;
     ...
     * For more information, see Routing Traffic to an Amazon CloudFront Web Distribution by Using Your Domain Name in the *Developer Guide*.
     ...
     */
    ViewerCertificate?: ViewerCertificateType;
   ...
   * A complex type that specifies how CloudFront handles query strings, cookies, and HTTP headers.
   */
  export type ForwardedValuesType = {
    /**
     * This field is deprecated. We recommend that you use a cache policy or an origin request policy instead of this field.
     * If you want to include cookies in the cache key, use a cache policy. For more information, see Creating cache policies in the *Amazon CloudFront Developer Guide*.
     * If you want to send cookies to the origin but not include them in the cache key, use an origin request policy. For more information, see Creating origin request policies in the *Amazon CloudFront Developer Guide*.
   ...
   */
  export type FunctionAssociationType = {
    /**
   ...
   */
  export type LambdaFunctionAssociationType = {
    /**
  ...
  /**
   * A custom origin. A custom origin is any origin that is *not* an S3 bucket, with one exception. An S3 bucket that is configured with static website hosting *is* a custom origin.
   * This property is legacy. We recommend that you use Origin instead.
   */
  export type LegacyCustomOriginType = {
    /**
     ...
     * For more information, see Minimum Origin SSL Protocol in the *Developer Guide*.
     */
    OriginSSLProtocols: string[];
  };
   ...
   * This property is legacy. We recommend that you use Origin instead.
   */
  export type LegacyS3OriginType = {
    /**
     * The domain name assigned to your CF distribution.
     */
    DNSName: string;
  ...
  export type OriginType = {
     ...
     */
    CustomOriginConfig?: CustomOriginConfigType;
     ...
     */
    OriginCustomHeaders?: OriginCustomHeaderType[];
     ...
     */
    OriginShield?: OriginShieldType;

    /**
     * Use this type to specify an origin that is an Amazon S3 bucket that is not configured with static website hosting. To specify any other type of origin, including an Amazon S3 bucket that is configured with static website hosting, use the `CustomOriginConfig` type instead.
     */
    S3OriginConfig?: S3OriginConfigType;

    VpcOriginConfig?: VpcOriginConfigType;
  };

  /**
   * A complex type that contains `HeaderName` and `HeaderValue` elements, if any, for this distribution.
   */
  export type OriginCustomHeaderType = {
    /**
  ...
  export type OriginGroupType = {
     ...
     */
    FailoverCriteria: OriginGroupFailoverCriteriaType;
     ...
     */
    Members: OriginGroupMembersType;
     ...
     */
    SelectionCriteria?: OriginGroupSelectionCriteriaType;
  };

  /**
   * A complex data type that includes information about the failover criteria for an origin group, including the status codes for which CloudFront will failover from the primary origin to the second origin.
   */
  export type OriginGroupFailoverCriteriaType = {
    /**
   ...
   */
  export type OriginGroupMemberType = {
    /**
   ...
   */
  export type OriginGroupMembersType = {
    /**
     * Items (origins) in an origin group.
     */
    Items: OriginGroupMemberType[];
  ...
  export type OriginGroupSelectionCriteriaType = {};

  /**
   * A complex data type for the origin groups specified for a distribution.
   */
  export type OriginGroupsType = {
    /**
     * The items (origin groups) in a distribution.
     */
    Items?: OriginGroupType[];
   ...
   */
  export type S3OriginConfigType = {
    /**
     * If you're using origin access control (OAC) instead of origin access identity, specify an empty `OriginAccessIdentity` element. For more information, see Restricting access to an in the *Amazon CloudFront Developer Guide*.
   ...
   */
  export type ViewerCertificateType = {
    /**
     * In CloudFormation, this field name is `AcmCertificateArn`. Note the different capitalization.
     * If the distribution uses `Aliases` (alternate domain names or CNAMEs) and the SSL/TLS certificate is stored in (ACM), provide the Amazon Resource Name (ARN) of the ACM certificate. CloudFront only supports ACM certificates in the US East (N. Virginia) Region (`us-east-1`).
     ...
     * If the distribution uses `Aliases` (alternate domain names or CNAMEs) and the SSL/TLS certificate is stored in (IAM), provide the ID of the IAM certificate.
  ...
  export type VpcOriginConfigType = {
    OriginKeepaliveTimeout?: number;
  ...
  export type DistributionResourceType = {
     ...
     */
    DistributionConfig: DistributionConfigType;
